...
function parseWallets(donationUrl: string | undefined): WalletInfo {
  ...
  try {
    ...
    if (path.includes("/bitcoin/") && wallet) return { btc: wallet, usdt: null };
    if (path.includes("/ethereum/") && wallet) return { btc: null, usdt: wallet };
  } catch {
    // ignore
  }
...
export const DonationModal = ({
  ...
  return (
    ...
    >
      ...
      {view === "input" && (
        <>
          <Header subtitle={t("donation.helpKeepAlive")} />
          <DialogContent sx={{ px: 2.5, pt: 2.5, pb: 2.5 }}>
            {/* Currency dropdown */}
            <FormControl fullWidth size="small" sx={{ mb: 2.5 }}>
              <InputLabel
                sx={{ color: "#8b949e", fontSize: "0.85rem", "&.Mui-focused": { color: "#58a6ff" } }}
              >
              ...
              >
                <MenuItem value="usdt" disabled={!wallets.usdt} sx={{ py: 0.75, minHeight: "unset" }}>
            ...
            <Typography
              ...
              fontFamily="Inter, sans-serif"
              fontWeight={600}
              sx={{ display: "block", mb: 0.75, textTransform: "uppercase", letterSpacing: "0.05em", fontSize: "0.7rem" }}
            >
              ...
              <TextField
                ...
                sx={{
                  ...
                  "& .MuiOutlinedInput-root": {
                    bgcolor: "#0d1117", fontFamily: "monospace", color: "#e6edf3",
            ...
            <Box sx={{ display: "flex", justifyContent: "center" }}>
              <Button
                ...
                sx={{
                  ...
                  boxShadow: "none",
                  "&:hover": { bgcolor: crypto === "btc" ? "#e3a918" : "#2ea043", boxShadow: "none" },
                  "&.Mui-disabled": { bgcolor: "#21262d", color: "#484f58", borderColor: "#21262d" },
                }}
              >
                {t("donation.donate")}
              </Button>
      ...
      {/* ─── PAYMENT VIEW ───────────────────────────────────────────────── */}
      {(view === "payment" || view === "verifying" || view === "not_found") && activeWallet && (
        <>
          <Header subtitle={t("donation.helpKeepAlive")} />
          <DialogContent sx={{ px: 2.5, pt: 2.5, pb: 2.5, textAlign: "center" }}>
            {/* QR Code */}
            <Box
              sx={{
                display: "inline-flex",
            ...
            <Typography
              ...
              color="#8b949e"
              fontWeight={600}
              sx={{ display: "block", textTransform: "uppercase", letterSpacing: "0.05em", fontSize: "0.7rem", mb: 0.5 }}
            >
            ...
            <Box
              sx={{
                ...
                px: 1.5, py: 0.75, mt: 1.5, mb: 2,
                bgcolor: "#0d1117", border: "1px solid #21262d",
                borderRadius: "6px", textAlign: "left",
              }}
            >
              <Typography
                variant="caption" fontFamily="monospace" color="#8b949e"
                sx={{ flex: 1, wordBreak: "break-all", lineHeight: 1.5, fontSize: "0.72rem" }}
              >
                {activeWallet}
              </Typography>
              <Tooltip title={copied ? t("donation.copied") : t("donation.copyAddress")} arrow placement="top">
                <IconButton
                  size="small"
                  onClick={() => handleCopy(activeWallet)}
                  sx={{
                    color: copied ? "#3fb950" : "#6e7681", flexShrink: 0,
                    "&:hover": { color: "#e6edf3", bgcolor: "rgba(110,118,129,0.1)" },
                  }}
                >
            ...
            {view === "not_found" && (
              <Box
                sx={{
                  display: "flex", alignItems: "center", gap: 1,
                  px: 1.5, py: 1, mb: 2,
                  bgcolor: "rgba(248,81,73,0.06)", border: "1px solid rgba(248,81,73,0.25)",
                  borderRadius: "6px",
                }}
              >
                <ErrorOutlineRounded sx={{ color: "#f85149", fontSize: "1rem", flexShrink: 0 }} />
                <Typography variant="caption" color="#f85149" fontSize="0.78rem" textAlign="left">
            ...
            <Button
              ...
              sx={{
                ...
                fontWeight: 600, fontFamily: "Inter, sans-serif",
                fontSize: "0.875rem", textTransform: "none",
                color: "#58a6ff", borderColor: "rgba(88,166,255,0.4)",
                "&:hover": { borderColor: "#58a6ff", bgcolor: "rgba(88,166,255,0.08)" },
                "&.Mui-disabled": { color: "#484f58", borderColor: "#21262d" },
              }}
            >
              {view === "verifying" ? t("donation.verifying") : t("donation.verify")}
            </Button>
            ...
            <Box sx={{ mt: 1 }}>
              <Button
                ...
                disabled={view === "verifying"}
                sx={{ color: "#6e7681", textTransform: "none", fontSize: "0.78rem" }}
              >
                ← {t("donation.back")}
              </Button>
            </Box>
      ...
      {view === "success" && (
        <>
          <Header subtitle={t("donation.thankYou")} />
          <DialogContent sx={{ px: 2.5, pt: 3, pb: 3, textAlign: "center" }}>
            <CheckCircleRounded sx={{ fontSize: 56, color: "#3fb950", mb: 1.5 }} />
            <Typography variant="h6" fontWeight={700} color="#e6edf3" fontFamily="Inter, sans-serif" mb={0.5}>
            ...
            {verifyTxId && (
              <Typography
                variant="caption" fontFamily="monospace" color="#6e7681"
                sx={{ display: "block", wordBreak: "break-all", fontSize: "0.7rem", mb: 2 }}
              >
                TX: {verifyTxId}
              </Typography>
            )}
            <Button
              ...
              onClick={handleClose}
              sx={{
                px: 4, py: 1, fontWeight: 600, fontFamily: "Inter, sans-serif",
                textTransform: "none", bgcolor: "#238636",
                "&:hover": { bgcolor: "#2ea043" }, boxShadow: "none",
              }}
            >
              {t("donation.close")}
            </Button>
