...
export function DependencyInfoPopover({
	...
	const depsSizeMB = processedDeps.reduce((sum, dep) => {
	...
	const hasUnknownSize =
		...
		processedDeps.some(
			(dep) => dep.size === "Unknown" || dep.localeSize === "Unknown",
		);
						...
						>
							...
							>
								...
								{coreLocaleSize && (
									...
									>
										+ {formatSize(coreLocaleSizeMB, coreLocaleSize)} (
										{t("dependency.locale")})
									</Typography>
								)}
							</Box>
