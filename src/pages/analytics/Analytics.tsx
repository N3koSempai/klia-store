...
export const Analytics = ({ onBack }: AnalyticsProps) => {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: loadAnalytics and loadPermissions are component functions; adding them without useCallback would cause infinite re-runs
	useEffect(() => {
		loadAnalytics();
		loadPermissions();
